...
namespace MusicXmlDb.Server.Migrations
{
    ...
    [Migration("20250301164034_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicXmlDb.Server.MusicXmlDocuments.ScoreDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MusicXmlDb.Server.MusicXmlDocuments.ScoreDocumentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MusicXmlDb.Server.MusicXmlDocuments.MusicXmlDocument", b =>
                {
                    b.HasOne("MusicXmlDb.Server.MusicXmlDocuments.ScoreDocumentHistory", "ScoreDocumentHistory")
            ...
            modelBuilder.Entity("MusicXmlDb.Server.MusicXmlDocuments.ScoreDocumentHistory", b =>
                {
                    b.HasOne("MusicXmlDb.Server.MusicXmlDocuments.ScoreDocument", "ScoreDocument")
                        .WithMany("History")
